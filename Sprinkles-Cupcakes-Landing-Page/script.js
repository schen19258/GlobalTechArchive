...
// Dev Shop code
function showFlavor() {
  let todaysFlavor = findFlavorObject();
  console.log(todaysFlavor);
  let imgElement = document.getElementById('featured-cupcake-img');
  let textElement = document.getElementById('featured-cupcake-name');
  imgElement.src = todaysFlavor.img;
  textElement.innerText = todaysFlavor.name;
}